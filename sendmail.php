...
$sendto = 'gary@castawayministries.com';

//        The subject you'll see in your inbox
$subject = 'Contact from contact form on website';

//        Message for the user when he/she doesn't fill in the form correctly.
$errormessage = 'Oops! There seems to have been a problem. Email Mark Johnson at mjohnson24@comcast.net if theres an error.';

//        Message for the user when he/she fills in the form correctly.
$thanks = "Thanks for the email! We will get back to you as soon as possible.";
