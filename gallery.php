...
<!-- Page Title -->
<title><?php echo $titlePage_Gallery; ?></title>
...
<?php include('includes/header.php'); ?>
      ...
      <div id="slider">
        ...
        <div id="page-name">
          <h2>Gallery</h2>
          <p class="tagline">Check out our photo gallery</p>
        </div>
        <!-- Page-Name END here -->
      </div>
      <!-- Slider END here -->
    ...
    <div class="container">
      ...
      <div id="full-width">
        ...
        <!--<div class="portfolio-item">
          <div class="port-box">
            <a href="<?php echo $nav_2009 ?>">
              <img src="images/portfolio/port1.jpg" alt="" class="port-img" />
            </a>
          </div>
          <h3>Graduation 2009</h3>
          <p>Graduation 2009.<br />(Steve Hudson and Edward Smith. 1st two for 2009).</p>
        </div>-->
        ...
        <div class="portfolio-item">
          <div class="port-box">
            <a href="<?php echo $nav_2013 ?>">
              <img src="images/portfolio/grad2013/thumb/CastawayGrad2013-5.jpg" alt="" class="port-img" />
            </a>
          </div>
          <h3>Graduation 2013</h3>
          <p>Graduation 2013</p>
        </div>
        <!-- Portfolio-Item END here -->
        ...
        <div class="portfolio-item">
          <div class="port-box">
            <a href="<?php echo $nav_2016 ?>">
              <img src="images/portfolio/grad2016/thumb/CastawayGrad2016-1.jpg" alt="" class="port-img" />
            </a>
          </div>
